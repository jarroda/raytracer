...
public abstract class Traceable
{
  ...
  Vector3 baseColor = new Vector3(1, 1, 1);     // For ambient and diffuse calculations
  Vector3 specularColor = new Vector3(1, 1, 1); // For specular highlights
  double specularExponent = 0;                  // AKA shininess
  ...
  */
  ...
  public void dump()
  {
    ...
    System.out.println("The modeling matrix:");
    mm.dump();
  }
}
