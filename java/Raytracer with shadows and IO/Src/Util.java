...
public class Util
{
  ...
  public static double epsilon = nearlyZero;
  ...
  */
  ...
  /**
    ...
    quadratic equation ax^2 + bx + c = 0. Returns an empty list if there
      ...
      if ( d < 0 )                             // Solutions are complex
        return v;
           ...
           else
           {
             ...
             v.insertIfPositive(x1);
             v.insertIfPositive(x2);
             return v;
           }
    }
  }

  public static void plot(Graphics2D g, int x, int y, RGBColor c)
  {
