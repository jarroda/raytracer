  ...
  */
  public void translate(double tx, double ty, double tz)
  {
    super.translate(tx, ty, tz);
	 Matrix m = Matrix.translationMatrix(-tx, -ty, -tz);
//	 Inv = Matrix.multiply(Inv, m);
	 Inv = Matrix.multiply(m, Inv);
//    Inv.translate(-tx, -ty, -tz);
  ...
  */
  public void scale(double sx, double sy, double sz)
  {
    super.scale(sx, sy, sz);
	 Matrix m = Matrix.scaleMatrix(1 / sx, 1 / sy, 1 / sz);
	 Inv = Matrix.multiply(m, Inv);
  }
  ...
  */
  public void rotateSC(double s, double c, double x, double y, double z)
  {
    super.rotateSC(s, c, x, y, z);
	 Matrix m = rotationMatrixSC(-s, c, x, y, z);
	 Inv = Matrix.multiply(m, Inv);
  }
  ...
  */
  ...
  {
    super.reflectOrigin();
	 Matrix m = reflectionOriginMatrix();
	 Inv = Matrix.multiply(m, Inv);
  }
