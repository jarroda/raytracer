...
public class Viewing
{
  ...
  */
  public static Matrix viewingTransform(
                         ...
                         Vector3 up)
  {
    Vector3 F = Vector3Util.difference(center, eye);
    Vector3 f = Vector3Util.normalize(F);
    Vector3 upp = Vector3Util.normalize(up);
    Vector3 s = Vector3Util.crossProduct(f, upp);
    Vector3 u = Vector3Util.crossProduct(s, f);
    Vector3 sp = Vector3Util.normalize(s);
    Vector3 uprime = Vector3Util.normalize(u);
